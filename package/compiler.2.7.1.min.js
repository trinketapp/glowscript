...
!function(){"use strict";function e(e,n){for(var i=0;i<l.length;i++){var r=l[i];if(e.search(r)>=0)for(var a=e.match(r),t=a[0].slice(0,-1),s=e.lastIndexOf(")"),o=e.slice(s),f=1,v="";s>=0&&(s--,!(s<0));)switch(e[s]){case"'":case'"':return[e.slice(0,s+1)+","+c+o,!0,t];case")":f++;break;case"(":if(f--,0===f)return"wait"==v||"_"==v?[e.slice(0,s+1)+c+o,!0,t]:0===v.length?[e.slice(0,s+1)+c+o,!0,t]:[e.slice(0,s+1)+v+","+c+o,!0,t];break;case",":if(1===f)return"wait"==v?[e.slice(0,s+1)+c+o,!0,t]:[e,!1,""];break;case" ":break;default:v=e[s]+v}}return[e,!1,""]}function n(n,i){var r,a,l,f,v,g,p,h,u={},d=0,w=0,b=0,R=!1,m=null,x=null,_=null,k="",E=/(^\s*)(.*)/,y="",O="",S=!1,j=!1,G=-1,C='"',M=[],q=/(\.pick)\s*(.)/,I=new RegExp("^classs*[^:]:"),T=new RegExp("def\\W*(\\w*)\\s*\\("),W=new RegExp("(\\w*)\\W*(\\w*)\\s*\\("),A=/^print_options/;for(l=n.split("\n"),a=0;a<l.length;a++)if(h="",v=l[a].match(E),k=v[1],f=v[2],("javascript"!=i||"//"!=f.slice(0,2))&&"#"!=f[0]){if(v=f.match(A),v&&(f=f.replace(/delete/,"remove")),"javascript"!=i&&"@"==f[0]){var z=l[a+1];if(v=z.match(E),"def"!=v[2].slice(0,3)&&"module"!=v[2].slice(0,6))continue;h=f,k=v[1],f=v[2],a++}if(0!==f.length){if(p=b,"javascript"!=i?(G===k.length&&(G=-1),M.length>0&&k.length<=M[M.length-1][1]&&(Z=M.pop(),R=!1)):M.length>0&&b===M[M.length-1][3]&&(Z=M.pop(),R=!1),"javascript"!=i&&f.match(I)&&(G=k.length),"vpython"==i){null===t&&(s=[]);var J=f.split(" ");if("__future__"==J[1])continue;if("visual.factorial"==J[1])continue;if("from"==J[0]&&"import"==J[2]&&J.length>=4){if("visual.graph"==J[1]){if("*"==J[3])continue;return'ERROR: Currently only "from visual.graph import *" is supported, line '+(a+2)+": "+l[a]}if("vpython"!=J[1]&&"visual"!=J[1]&&"vis"!=J[1])throw new Error("Line "+(a+2)+": cannot import from "+J[1]);if(null===t){if("*"==J[3])continue;t=J[1];for(var L=3;L<J.length;L++)if(J[L].length>0&&","!=J[L]){if(","==J[L].slice(-1)&&(J[L]=J[L].slice(0,-1))," "==J[L]||"("==J[L]||")"==J[L]||"("==J[L][0]||")"==J[L][-1])continue;s.push(J[L])}}continue}if("import"==J[0]&&2==J.length){if("visual.graph"==J[1])return'ERROR: Currently only "from visual.graph import *" is supported, line '+(a+2)+": "+l[a];if("vpython"!=J[1]&&"visual"!=J[1]&&"vis"!=J[1])return"ERROR: Cannot import from "+J[1]+", line "+(a+2)+": "+l[a];null===t&&(t=J[1]);continue}if("import"==J[0]){if("vpython"==J[1]||"visual"==J[1]||"vis"==J[1]){if(4==J.length&&"as"==J[2]){t=J[3];continue}return"ERROR: improper import statement, line "+(a+2)+": "+l[a]}return"ERROR: Cannot import from "+J[1]+", line "+(a+2)+": "+l[a]}}for(var P=!1,U=!1,B=!1,D=S,F=!1,H=!1,K=0;K<f.length;K++){var N=U||P||F,Q=f[K];if("\\"==Q&&K<f.length-1&&" "!==f[K+1])K++;else{switch(Q){case"#":U||P||F||(f=f.slice(0,K));break;case'"':if(K<=f.length-3&&'"'==f[K+1]&&'"'==f[K+2]){if(F&&K<=f.length-4&&'"'==f[K+3])break;F=!F,H=!0,K+=2}else F||U||(P=!P);break;case"'":if(K<=f.length-3&&"'"==f[K+1]&&"'"==f[K+2]){if(F&&K<=f.length-4&&"'"==f[K+3])break;F=!F,H=!0,K+=2}else F||P||(U=!U)}if(F&&K==f.length-1&&a<l.length-1&&(a++,f+="\n"+l[a]),U||P||F){if(K<f.length-1)continue;if(a===l.length-1){var V="single";return V=P?"double":"triple","ERROR: Unbalanced "+V+" quotes"}}switch(Q){case":":1==d&&0===b&&0===w&&(j=!0);break;case"(":if(K>0&&"\\"==f[K-1])break;0===d&&(m=a),d++;break;case")":if(K>0&&"\\"==f[K-1])break;d--,j&&0==d&&(j=!1);break;case"[":if(K>0&&"\\"==f[K-1])break;0===w&&(x=a),w++;break;case"]":if(K>0&&"\\"==f[K-1])break;w--;break;case"{":if(K>0&&"\\"==f[K-1])break;0===b&&(_=a),b++;break;case"}":if(K>0&&"\\"==f[K-1])break;b--}if("\\"==Q){K!=f.length-1&&" "!=f[K+1]&&"#"!=f[K+1]||(f=f.slice(0,K)),B=!0;break}}}if(S=!j&&(B||d>0||w>0||b>0),!N){if("vpython"==i){var v=q.exec(f+" ");if(v&&"("!=v[2]&&0!=v[2].search(/\w/)){var K=v.index;f=f.slice(0,K)+".pick()"+f.slice(K+5)}}if(!H){var X=!0;if("javascript"!=i){var v=T.exec(f);if(null!==v){var Y=v[1];G>=0&&(Y="."+Y),M.push([y.length,k.length,Y,p]),X=!1}}else{var v=W.exec(f);if(null!==v&&("function"==v[1]||"function"==v[2])){var Y;"function"==v[1]?Y=v[2]:"function"==v[2]&&(Y=v[1]),M.push([y.length,k.length,Y,p]),X=!1}}if(X){var Z=(f.length,e(f,i));if(f=Z[0],Z[1]&&M.length>0){var $=M[M.length-1];if(!R){R=!0,void 0===u[$[2]]&&(u[$[2]]=Z[2]);var ee,g=$[0];if("javascript"!=i)for(ee=y.slice(g).search(/:/)+g;")"!==y[ee];)ee--;else{ee=y.slice(g).search(/\(/);for(var ne=1;ne>0;)switch(ee++,y[g+ee]){case"(":ne++;break;case")":ne--}ee+=g}for(var K=ee-1;" "==y[K];)K--;var ie;if("("==y[K])y=y.slice(0,ee)+c+y.slice(ee);else{for(var re=K;;){K--;var r=y[K];if(","==r||" "==r||"("==r)break}ie=y.slice(K+1,re+1),ie!=c&&(y="wait"==ie?y.slice(0,K+1)+c+y.slice(ee):y.slice(0,ee)+","+c+y.slice(ee))}}}}}}if("vpython"==i||"rapydscript"==i?(r="",r=k.length<O.length&&(")"==f.charAt(0)||"else"==f.substr(0,4)||"elif"==f.substr(0,4)||"except"==f.substr(0,6)||"finally"==f.substr(0,7))?O+o+C+(a+2)+C+"\n":k+o+C+(a+2)+C+"\n",k.length!=O.length||"elif"!=f.substr(0,4)&&"else"!=f.substr(0,4)?'"""'!=f.substr(0,3)&&"'''"!=f.substr(0,3)&&")"!=f[0]||(r=""):r="",D?(y=y.slice(0,-1)+k+f+"\n",k=O):""==r?y+="  "+k+f+"\n":h.length>0?(y+="  "+r+"  "+k+h+"\n",y+="  "+k+f+"\n"):y+="  "+r+"  "+k+f+"\n"):y+=k+f+"\n",O=k,d<0)return"ERROR: Too many right parentheses, line "+(a+2)+": "+l[a];if(w<0)return"ERROR: Too many right brackets, line "+(a+2)+": "+l[a];if(b<0)return"ERROR: Too many right braces, line "+(a+2)+": "+l[a]}}for(var K in u){var Y=K,ae=u[K],te="."==ae[0]?ae.slice(1):ae,se=new RegExp("\\.bind[^,]*,\\s*"+Y+"\\s*\\)"),le=y.search(se);if(le>=0)throw new Error("Cannot bind function '"+Y+"' to an event because it contains a "+te+" statement.");if(se=new RegExp("\\s*bind\\s*=\\s*"+Y+"\\s*\\)"),le=y.search(se),le>=0)throw new Error("Cannot bind function '"+Y+"' to a widget because it contains a "+te+" statement.");for(se=new RegExp("(\\w*)\\W*"+Y+"\\s*\\(","g");;){var v=se.exec(y);if(null===v)break;if("def"!=v[1]&&"function"!=v[1])for(var ne=1,le=se.lastIndex-1,ce=le+1,oe=0,fe="",ve=!1,ge=!1;ne>0;)switch(le++,y[le]){case"'":ve=!ve;break;case'"':ge=!ge;break;case" ":break;case"(":ve||ge||ne++;break;case",":1==ne&&(oe=le,ce=le+1,fe="");break;case")":ve||ge||ne--,0===ne&&(fe.length>0?"wait"==fe||"_"==fe?y=oe>0?y.slice(0,oe+1)+c+y.slice(le):y.slice(0,ce)+c+y.slice(ce+4):fe==c||(y=y.slice(0,le)+","+c+y.slice(le)):y=y.slice(0,ce)+c+y.slice(le));break;default:fe+=y[le]}}}return d>0?"ERROR: Missing right parenthesis, see line "+(m+2)+": "+l[m]:w>0?"ERROR: Missing right bracket, see line "+(x+2)+": "+l[x]:b>0?"ERROR: Missing right brace, see line "+(_+2)+": "+l[_]:y}function i(e){if("ERROR: "==e.slice(0,7))throw new Error(e.slice(7));void 0===a&&(a=RapydScript.create_embedded_compiler()),e+="\n";try{var n=a.compile(e,{js_version:5});return n.toString()}catch(i){if(void 0===i.line)throw new Error(i.message);var r=e.split("\n"),t=r[i.line],s=t.match(f);throw null!==s?new Error(i.message+"; line "+s[1]+": "+r[i.line+1]):new Error(i.message+": "+r[i.line])}}function r(e,r){r=r||{},window.__original={text:e.split("\n")},window.__GSlang=r.lang;var a='["'+r.version+'", "glowscript"]',l=/[^\.\w]text[\ ]*\(/,f=/^text[\ ]*\(/,p=l.exec(e);p||(p=f.exec(e));var h=e.indexOf("MathJax");if(h=h>=0,e=e.replace(/\.delete/g,".remove"),e=e.replace(/arange\s*\(/g,"range("),"rapydscript"==r.lang||"vpython"==r.lang){e=n(e,r.lang);var u="";if("ERROR: "==e.slice(0,7))i(e);else{var d;if("rapydscript"==r.lang)d="def main("+c+"):\n  version = "+a+"\n  window.__GSlang = 'rapydscript'\n  scene = canvas()\n  print = GSprint\n"+e+"main";else{if(d="def main("+c+"):\n  version = "+a+"\n",d+="  window.__GSlang = 'vpython'\n",null===t){for(var w=0;w<v.length;w++)d+="  "+v[w]+"=vp_"+v[w]+"\n";d+="  display=canvas\n  vector=vec\n"}else if(s.length>0){u+="  vector=vec\n";for(var w=0;w<v.length;w++){var b=v[w],R=s.indexOf(b);u+=R>=0?"  "+b+"=vp_"+b+"\n":"  "+b+"=undefined\n"}for(var m=s.indexOf("vector")>=0,w=0;w<g.length;w++){var b=g[w];if("vec"!=b||!m){var R=s.indexOf(b);R<0&&(u+="  "+b+"=undefined\n")}}d+=u}else{var x=new RegExp(t+"\\.(\\w+)","g"),_=e.match(x);x=new RegExp(t+"\\.(\\w+)");for(var k={},w=0;w<_.length;w++){var E=x.exec(_[w])[1];E in k||(k[E]=E)}var y="";u+="    var "+t+"={";for(var w=0;w<v.length;w++){var b=v[w];b in k?u+=b+":vp_"+b+", ":y+="  "+b+"=undefined\n"}u+="canvas:canvas, ";for(var w=0;w<g.length;w++){var b=g[w];if("canvas"!=b)if(b in k)u+="vector"==b?"vector:vec, ":b+":"+b+", ";else{if("vec"==b&&"vector"in k)continue;y+="  "+b+"=undefined\n"}}u=u.slice(0,-2)+"}\n",d+=y}d+="  print=GSprint\n",d+=null===t||s.length>0?"  scene = canvas()\n":"  scene = "+t+".canvas()\n",d+="  from pythonize import strings\n",d+="  strings()\n",d+=e}e=i(d);var O=e.indexOf("window.__GSlang"),S="Array.prototype['+']=function(r) {return this.concat(r)};\n";s.length<=0&&(S+=u),e=e.slice(0,O)+S+e.slice(O-4)}}else{e=n(e,r.lang);var d="function main("+c+") {\n";d+="var version = "+a+";\n",d+="var scene = canvas();\n",e=d+e+"\n};\nmain"}if(p){var j="scene = canvas();\n",G=e.indexOf(j)+j.length;j="    waitforfonts("+c+")\n",e=e.slice(0,G)+j+e.slice(G,e.length)}var C=papercompile(e),d=window.Streamline.transform(C,{alreadyParsed:!0});e=d.replace(/\n\n\n\n/g,""),"javascript"!=r.lang&&(e=e.replace(new RegExp(" "+o,"g")," ")),e=e.replace(/Math.pow/g,"GS_power"),p&&(e="fontloading();\n"+e);var j=c+"()",G=e.lastIndexOf(j);return G>-1&&(e=e.slice(0,G)+e.slice(G+j.length,e.length)),e}var a,t=null,s=[],l=[new RegExp("^rate\\s*\\("),new RegExp("sleep\\s*\\("),new RegExp("^get_library\\s*\\("),new RegExp("\\.waitfor\\s*\\("),new RegExp("\\.pause\\s*\\("),new RegExp("\\s*read_local_file\\s*\\(")],c="_",o="RS_ls = ",f=/"(\d*)"/,v=["box","sphere","cylinder","pyramid","cone","helix","ellipsoid","ring","arrow","compound"],g=["canvas","vec","vector","rate","sleep","update","color","extrusion","paths","shapes","vertex","triangle","quad","label","distant_light","local_light","attach_trail","attach_arrow","sqrt","pi","abs","sin","cos","tan","asin","acos","atan","atan2","exp","log","pow","factorial","combin","button","radio","checkbox","slider","checkbox","text","radians","degrees","get_library","read_local_file"];window.glowscript_compile=r}();
