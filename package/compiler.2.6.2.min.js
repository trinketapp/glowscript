...
!function(){"use strict";function e(e,n){for(var r=0;r<l.length;r++){var i=l[r];if(e.search(i)>=0)for(var a=e.lastIndexOf(")"),t=e.slice(a),s=1,o="";a>=0&&(a--,!(a<0));)switch(e[a]){case"'":case'"':return[e.slice(0,a+1)+","+c+t,!0];case")":s++;break;case"(":if(s--,0===s)return"wait"==o||"_"==o?[e.slice(0,a+1)+c+t,!0]:0===o.length?[e.slice(0,a+1)+c+t,!0]:[e.slice(0,a+1)+o+","+c+t,!0];break;case",":if(1===s)return"wait"==o?[e.slice(0,a+1)+c+t,!0]:[e,!1];break;case" ":break;default:o=e[a]+o}}return[e,!1]}function n(n,r){var i,a,l,f,g,v,p,h,u=[],d=0,w=0,R=0,b=!1,m=null,x=null,_=null,k="",E=/(^\s*)(.*)/,y="",O="",S=!1,j=!1,G=-1,M='"',C=[],q=/(\.pick)\s*(.)/,I=new RegExp("^classs*[^:]:"),T=new RegExp("def\\W*(\\w*)\\s*\\("),W=new RegExp("(\\w*)\\W*(\\w*)\\s*\\("),A=/^print_options/;for(l=n.split("\n"),a=0;a<l.length;a++)if(h="",g=l[a].match(E),k=g[1],f=g[2],("javascript"!=r||"//"!=f.slice(0,2))&&"#"!=f[0]){if(g=f.match(A),g&&(f=f.replace(/delete/,"remove")),"javascript"!=r&&"@"==f[0]){var z=l[a+1];if(g=z.match(E),"def"!=g[2].slice(0,3)&&"module"!=g[2].slice(0,6))continue;h=f,k=g[1],f=g[2],a++}if(0!==f.length){if(p=R,"javascript"!=r?(G===k.length&&(G=-1),C.length>0&&k.length<=C[C.length-1][1]&&(Z=C.pop(),b=!1)):C.length>0&&R===C[C.length-1][3]&&(Z=C.pop(),b=!1),"javascript"!=r&&f.match(I)&&(G=k.length),"vpython"==r){null===t&&(s=[]);var J=f.split(" ");if("__future__"==J[1])continue;if("visual.factorial"==J[1])continue;if("from"==J[0]&&"import"==J[2]&&J.length>=4){if("visual.graph"==J[1]){if("*"==J[3])continue;return'ERROR: Currently only "from visual.graph import *" is supported, line '+(a+2)+": "+l[a]}if("vpython"!=J[1]&&"visual"!=J[1]&&"vis"!=J[1])throw new Error("Line "+(a+2)+": cannot import from "+J[1]);if(null===t){if("*"==J[3])continue;t=J[1];for(var L=3;L<J.length;L++)if(J[L].length>0&&","!=J[L]){if(","==J[L].slice(-1)&&(J[L]=J[L].slice(0,-1))," "==J[L]||"("==J[L]||")"==J[L]||"("==J[L][0]||")"==J[L][-1])continue;s.push(J[L])}}continue}if("import"==J[0]&&2==J.length){if("visual.graph"==J[1])return'ERROR: Currently only "from visual.graph import *" is supported, line '+(a+2)+": "+l[a];if("vpython"!=J[1]&&"visual"!=J[1]&&"vis"!=J[1])return"ERROR: Cannot import from "+J[1]+", line "+(a+2)+": "+l[a];null===t&&(t=J[1]);continue}if("import"==J[0]){if("vpython"==J[1]||"visual"==J[1]||"vis"==J[1]){if(4==J.length&&"as"==J[2]){t=J[3];continue}return"ERROR: improper import statement, line "+(a+2)+": "+l[a]}return"ERROR: Cannot import from "+J[1]+", line "+(a+2)+": "+l[a]}}for(var P=!1,U=!1,B=!1,D=S,F=!1,H=!1,K=0;K<f.length;K++){var N=U||P||F,Q=f[K];if("\\"==Q&&K<f.length-1&&" "!==f[K+1])K++;else{switch(Q){case"#":U||P||F||(f=f.slice(0,K));break;case'"':if(K<=f.length-3&&'"'==f[K+1]&&'"'==f[K+2]){if(F&&K<=f.length-4&&'"'==f[K+3])break;F=!F,H=!0,K+=2}else F||U||(P=!P);break;case"'":if(K<=f.length-3&&"'"==f[K+1]&&"'"==f[K+2]){if(F&&K<=f.length-4&&"'"==f[K+3])break;F=!F,H=!0,K+=2}else F||P||(U=!U)}if(F&&K==f.length-1&&a<l.length-1&&(a++,f+="\n"+l[a]),U||P||F){if(K<f.length-1)continue;if(a===l.length-1){var V="single";return V=P?"double":"triple","ERROR: Unbalanced "+V+" quotes"}}switch(Q){case":":1==d&&(j=!0);break;case"(":if(K>0&&"\\"==f[K-1])break;0===d&&(m=a),d++;break;case")":if(K>0&&"\\"==f[K-1])break;d--,j&&0==d&&(j=!1);break;case"[":if(K>0&&"\\"==f[K-1])break;0===w&&(x=a),w++;break;case"]":if(K>0&&"\\"==f[K-1])break;w--;break;case"{":if(K>0&&"\\"==f[K-1])break;0===R&&(_=a),R++;break;case"}":if(K>0&&"\\"==f[K-1])break;R--}if("\\"==Q){K!=f.length-1&&" "!=f[K+1]&&"#"!=f[K+1]||(f=f.slice(0,K)),B=!0;break}}}if(S=!j&&(B||d>0||w>0||R>0),!N){if("vpython"==r){var g=q.exec(f+" ");if(g&&"("!=g[2]&&0!=g[2].search(/\w/)){var K=g.index;f=f.slice(0,K)+".pick()"+f.slice(K+5)}}if(!H){var X=!0;if("javascript"!=r){var g=T.exec(f);if(null!==g){var Y=g[1];G>=0&&(Y="."+Y),C.push([y.length,k.length,Y,p]),X=!1}}else{var g=W.exec(f);if(null!==g&&("function"==g[1]||"function"==g[2])){var Y;"function"==g[1]?Y=g[2]:"function"==g[2]&&(Y=g[1]),C.push([y.length,k.length,Y,p]),X=!1}}if(X){var Z=(f.length,e(f,r));if(f=Z[0],Z[1]&&C.length>0){var $=C[C.length-1];if(!b){b=!0,u.indexOf($[2])==-1&&u.push($[2]);var ee,v=$[0];if("javascript"!=r)for(ee=y.slice(v).search(/:/)+v;")"!==y[ee];)ee--;else{ee=y.slice(v).search(/\(/);for(var ne=1;ne>0;)switch(ee++,y[v+ee]){case"(":ne++;break;case")":ne--}ee+=v}for(var K=ee-1;" "==y[K];)K--;var re;if("("==y[K])y=y.slice(0,ee)+c+y.slice(ee);else{for(var ie=K;;){K--;var i=y[K];if(","==i||" "==i||"("==i)break}re=y.slice(K+1,ie+1),re!=c&&(y="wait"==re?y.slice(0,K+1)+c+y.slice(ee):y.slice(0,ee)+","+c+y.slice(ee))}}}}}}if("vpython"==r||"rapydscript"==r?(i="",i=k.length<O.length&&(")"==f.charAt(0)||"else"==f.substr(0,4)||"elif"==f.substr(0,4)||"except"==f.substr(0,6)||"finally"==f.substr(0,7))?O+o+M+(a+2)+M+"\n":k+o+M+(a+2)+M+"\n",k.length!=O.length||"elif"!=f.substr(0,4)&&"else"!=f.substr(0,4)?'"""'!=f.substr(0,3)&&"'''"!=f.substr(0,3)&&")"!=f[0]||(i=""):i="",D?(y=y.slice(0,-1)+k+f+"\n",k=O):""==i?y+="  "+k+f+"\n":h.length>0?(y+="  "+i+"  "+k+h+"\n",y+="  "+k+f+"\n"):y+="  "+i+"  "+k+f+"\n"):y+=k+f+"\n",O=k,d<0)return"ERROR: Too many right parentheses, line "+(a+2)+": "+l[a];if(w<0)return"ERROR: Too many right brackets, line "+(a+2)+": "+l[a];if(R<0)return"ERROR: Too many right braces, line "+(a+2)+": "+l[a]}}for(var K=0;K<u.length;K++){var ae,Y=u[K];for(ae="."==Y[0]?new RegExp("(\\w*)\\."+Y.slice(1)+"\\s*\\(","g"):new RegExp("(\\w*)\\W*"+Y+"\\s*\\(","g");;){var g=ae.exec(y);if(null===g)break;if("def"!=g[1]&&"function"!=g[1])for(var ne=1,te=ae.lastIndex-1,se=te+1,le=0,ce="",oe=!1,fe=!1;ne>0;)switch(te++,y[te]){case"'":oe=!oe;break;case'"':fe=!fe;break;case" ":break;case"(":oe||fe||ne++;break;case",":1==ne&&(le=te,se=te+1,ce="");break;case")":oe||fe||ne--,0===ne&&(ce.length>0?"wait"==ce||"_"==ce?y=le>0?y.slice(0,le+1)+c+y.slice(te):y.slice(0,se)+c+y.slice(se+4):ce==c||(y=y.slice(0,te)+","+c+y.slice(te)):y=y.slice(0,se)+c+y.slice(te));break;default:ce+=y[te]}}}return d>0?"ERROR: Missing right parenthesis, see line "+(m+2)+": "+l[m]:w>0?"ERROR: Missing right bracket, see line "+(x+2)+": "+l[x]:R>0?"ERROR: Missing right brace, see line "+(_+2)+": "+l[_]:y}function r(e){if("ERROR: "==e.slice(0,7))throw new Error(e.slice(7));void 0===a&&(a=RapydScript.create_embedded_compiler()),e+="\n";try{var n=a.compile(e,{js_version:5});return n.toString()}catch(r){if(void 0===r.line)throw new Error(r.message);var i=e.split("\n"),t=i[r.line],s=t.match(f);throw null!==s?new Error(r.message+"; line "+s[1]+": "+i[r.line+1]):new Error(r.message+": "+i[r.line])}}function i(e,i){i=i||{},window.__original={text:e.split("\n")},window.__GSlang=i.lang;var a='["'+i.version+'", "glowscript"]',l=/[^\.\w]text[\ ]*\(/,f=/^text[\ ]*\(/,p=l.exec(e);p||(p=f.exec(e));var h=e.indexOf("MathJax");if(h=h>=0,e=e.replace(/\.delete/g,".remove"),"rapydscript"==i.lang||"vpython"==i.lang){e=n(e,i.lang);var u="";if("ERROR: "==e.slice(0,7))r(e);else{var d;if("rapydscript"==i.lang)d="def main("+c+"):\n  version = "+a+"\n  window.__GSlang = 'rapydscript'\n  scene = canvas()\n  arange=range\n  print = GSprint\n"+e+"main";else{if(d="def main("+c+"):\n  version = "+a+"\n",d+="  window.__GSlang = 'vpython'\n",null===t){for(var w=0;w<g.length;w++)d+="  "+g[w]+"=vp_"+g[w]+"\n";d+="  display=canvas\n  vector=vec\n"}else if(s.length>0){u+="  vector=vec\n";for(var w=0;w<g.length;w++){var R=g[w],b=s.indexOf(R);u+=b>=0?"  "+R+"=vp_"+R+"\n":"  "+R+"=undefined\n"}for(var m=s.indexOf("vector")>=0,w=0;w<v.length;w++){var R=v[w];if("vec"!=R||!m){var b=s.indexOf(R);b<0&&(u+="  "+R+"=undefined\n")}}d+=u}else{var x=new RegExp(t+"\\.(\\w+)","g"),_=e.match(x);x=new RegExp(t+"\\.(\\w+)");for(var k={},w=0;w<_.length;w++){var E=x.exec(_[w])[1];E in k||(k[E]=E)}var y="";u+="    var "+t+"={";for(var w=0;w<g.length;w++){var R=g[w];R in k?u+=R+":vp_"+R+", ":y+="  "+R+"=undefined\n"}u+="canvas:canvas, ";for(var w=0;w<v.length;w++){var R=v[w];if("canvas"!=R)if(R in k)u+="vector"==R?"vector:vec, ":R+":"+R+", ";else{if("vec"==R&&"vector"in k)continue;y+="  "+R+"=undefined\n"}}u=u.slice(0,-2)+"}\n",d+=y}d+="  print=GSprint\n  arange=range\n",d+=null===t||s.length>0?"  scene = canvas()\n":"  scene = "+t+".canvas()\n",d+="  from pythonize import strings\n",d+="  strings()\n",d+=e}e=r(d);var O=e.indexOf("window.__GSlang"),S="Array.prototype['+']=function(r) {return this.concat(r)};\n";s.length<=0&&(S+=u),e=e.slice(0,O)+S+e.slice(O-4)}}else{e=n(e,i.lang);var d="function main("+c+") {\n";d+="var version = "+a+";\n",d+="var scene = canvas();\n",e=d+e+"\n};\nmain"}if(p){var j="scene = canvas();\n",G=e.indexOf(j)+j.length;j="    waitforfonts("+c+")\n",e=e.slice(0,G)+j+e.slice(G,e.length)}var M=papercompile(e),d=window.Streamline.transform(M,{alreadyParsed:!0});e=d.replace(/\n\n\n\n/g,""),"javascript"!=i.lang&&(e=e.replace(new RegExp(" "+o,"g")," ")),e=e.replace(/Math.pow/g,"GS_power"),p&&(e="fontloading();\n"+e);var j=c+"()",G=e.lastIndexOf(j);return G>-1&&(e=e.slice(0,G)+e.slice(G+j.length,e.length)),e}var a,t=null,s=[],l=[new RegExp("^rate\\s*\\("),new RegExp("sleep\\s*\\("),new RegExp("^get_library\\s*\\("),new RegExp("\\.waitfor\\s*\\("),new RegExp("\\.pause\\s*\\("),new RegExp("=\\s*read_local_file\\s*\\(")],c="_",o="RS_ls = ",f=/"(\d*)"/,g=["box","sphere","cylinder","pyramid","cone","helix","ellipsoid","ring","arrow","compound","graph"],v=["canvas","vec","vector","rate","sleep","update","color","extrusion","paths","shapes","vertex","triangle","quad","label","distant_light","local_light","attach_trail","attach_arrow","sqrt","pi","abs","sin","cos","tan","asin","acos","atan","atan2","exp","log","pow","factorial","combin","button","radio","checkbox","slider","checkbox","text","radians","degrees","gdisplay","gcurve","gdots","gvbars","ghbars","get_library","read_local_file"];window.glowscript_compile=i}();
