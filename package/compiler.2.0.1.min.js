/*This is     a combined, compressed file.  Look at https://github.com/BruceSherwood/glowscript for source code and copyright information.*/!function(){"use strict";function e(e){for(var n=0;n<t.length;n++){var r=t[n];if(e.search(r)>=0)for(var i=e.lastIndexOf(")"),a=i,l=1,s="",c="";i>=0&&(i--,!(0>i));)switch(e[i]){case")":l++;break;case"(":if(l--,0===l)return 0===c.length?e.slice(0,i)+"(wait"+s+")":"wait"==c?e.slice(0,a)+s+" )":e.slice(0,a)+","+s+"wait)";break;case",":if(1===l)return"wait"==c?e.slice(0,i)+","+s+" wait)":e;break;case" ":s=" "+s;break;default:c=e[i]+c}}return e}function n(n,r){var i,t,s,c,o,p,f=0,v=0,g=0,h=null,u=null,d=null,w="",b=/(^\s*)(.*)/,m="",y="",_=!1,R=!1,k='"',E=[],x=/(\.pick)\s*(.)/,O=/def[^:]*:/,S=/class[^:]*:/;for(s=n.split("\n"),t=0;t<s.length;t++)if(p="",o=s[t].match(b),w=o[1],c=o[2],"#"!=c[0]){if("@"==c[0]){var $=s[t+1];if(o=$.match(b),"def"!=o[2].slice(0,3)&&"module"!=o[2].slice(0,6))continue;p=c,w=o[1],c=o[2],t++}if(0!==c.length){if("vpython"==r){E.length>0&&w.length<=E[E.length-1][1]&&E.pop(),null===a&&(l=[]);var G=c.split(" ");if("__future__"==G[1])continue;if("visual.factorial"==G[1])continue;if("from"==G[0]&&"import"==G[2]&&G.length>=4){if("visual.graph"==G[1]){if("*"==G[3])continue;return'ERROR: Currently only "from visual.graph import *" is supported, line '+(t+2)+": "+s[t]}if("visual"!=G[1]&&"vis"!=G[1])throw new Error("Line "+(t+2)+": cannot import from "+G[1]);if(null===a){if("*"==G[3])continue;a=G[1];for(var T=3;T<G.length;T++)if(G[T].length>0&&","!=G[T]){if(","==G[T].slice(-1)&&(G[T]=G[T].slice(0,-1))," "==G[T]||"("==G[T]||")"==G[T]||"("==G[T][0]||")"==G[T][-1])continue;l.push(G[T])}}continue}if("import"==G[0]&&2==G.length){if("visual.graph"==G[1])return'ERROR: Currently only "from visual.graph import *" is supported, line '+(t+2)+": "+s[t];if("visual"!=G[1]&&"vis"!=G[1])return"ERROR: Cannot import from "+G[1]+", line "+(t+2)+": "+s[t];null===a&&(a=G[1]);continue}}for(var q=!1,C=!1,M=!1,A=_,D=!1,I=!1,L=0;L<c.length;L++){var N=C||q||D,U=c[L];if("\\"==U&&L<c.length-1&&" "!==c[L+1])L++;else{switch(U){case"#":C||q||D||(c=c.slice(0,L));break;case'"':if(L<=c.length-3&&'"'==c[L+1]&&'"'==c[L+2]){if(D&&L<=c.length-4&&'"'==c[L+3])break;D=!D,I=!0,L+=2}else D||C||(q=!q);break;case"'":if(L<=c.length-3&&"'"==c[L+1]&&"'"==c[L+2]){if(D&&L<=c.length-4&&"'"==c[L+3])break;D=!D,I=!0,L+=2}else D||q||(C=!C)}if(D&&L==c.length-1&&t<s.length-1&&(t++,c+="\n"+s[t]),C||q||D){if(L<c.length-1)continue;if(t===s.length-1){var j="single";return j=q?"double":"triple","ERROR: Unbalanced "+j+" quotes"}}switch(U){case":":1==f&&(R=!0);break;case"(":if(L>0&&"\\"==c[L-1])break;0===f&&(h=t),f++;break;case")":if(L>0&&"\\"==c[L-1])break;f--,R&&0==f&&(R=!1);break;case"[":if(L>0&&"\\"==c[L-1])break;0===v&&(u=t),v++;break;case"]":if(L>0&&"\\"==c[L-1])break;v--;break;case"{":if(L>0&&"\\"==c[L-1])break;0===g&&(d=t),g++;break;case"}":if(L>0&&"\\"==c[L-1])break;g--}if("\\"==U){L!=c.length-1&&" "!=c[L+1]&&"#"!=c[L+1]||(c=c.slice(0,L)),M=!0;break}}}if(_=!R&&(M||f>0||v>0||g>0),"vpython"==r&&!N){var o=x.exec(c+" ");if(o&&"("!=o[2]&&0!=o[2].search(/\w/)){var L=o.index;c=c.slice(0,L)+".pick()"+c.slice(L+5)}if(!I)if(c=c.replace(/global/,"nonlocal"),c=c.replace(/\.mouse\.camera/g,".camera.pos"),c.search(O)>=0||c.search(S)>=0)E.push([m.length,w.length]);else{var z=c.length;if(c=e(c),c.length>z)for(;;){var B=E.pop();if(void 0==B)break;for(var F=m.slice(B[0]).search(/:/)+B[0];")"!==m[F];)F--;for(var L=F-1;" "==m[L];)L--;var H;H="("==m[L]?"wait":",wait",m=m.slice(0,F)+H+m.slice(F)}}}if(i="",i=!(w.length<y.length)||")"!=c.charAt(0)&&"else"!=c.substr(0,4)&&("rapydscript"!=r&&"vpython"!=r||"elif"!=c.substr(0,4)&&"except"!=c.substr(0,6)&&"finally"!=c.substr(0,7))?w+k+(t+2)+k+"\n":y+k+(t+2)+k+"\n","rapydscript"!=r&&"vpython"!=r||(w.length!=y.length||"elif"!=c.substr(0,4)&&"else"!=c.substr(0,4)?'"""'!=c.substr(0,3)&&"'''"!=c.substr(0,3)&&")"!=c[0]||(i=""):i=""),"rapydscript"==r||"vpython"==r?A?(m=m.slice(0,-1)+w+c+"\n",w=y):""==i?m+="  "+w+c+"\n":p.length>0?(m+="  "+i+"  "+w+p+"\n",m+="  "+w+c+"\n"):m+="  "+i+"  "+w+c+"\n":m+=i+s[t]+"\n",y=w,0>f)return"ERROR: Too many right parentheses, line "+(t+2)+": "+s[t];if(0>v)return"ERROR: Too many right brackets, line "+(t+2)+": "+s[t];if(0>g)return"ERROR: Too many right braces, line "+(t+2)+": "+s[t]}}return f>0?"ERROR: Missing right parenthesis, see line "+(h+2)+": "+s[h]:v>0?"ERROR: Missing right bracket, see line "+(u+2)+": "+s[u]:g>0?"ERROR: Missing right brace, see line "+(d+2)+": "+s[d]:m}function r(e){if("ERROR: "==e.slice(0,7))throw new Error(e.slice(7));var n=OutputStream(p);e+="\n";try{var r=parse(e,o);return r.print(n),n.toString()}catch(i){if(void 0===i.line)throw new Error(i.message);var a=e.split("\n"),l=a[i.line],t=l.match(c);throw null!==t?new Error(i.message+"; line "+t[1]+": "+a[i.line+1]):new Error(i.message+": "+a[i.line])}}function i(e,i){i=i||{};var t=i.wait||"wait";window.__original={text:e.split("\n")},window.__GSlang=i.lang;var c='["'+i.version+'", "glowscript"]';if(e=e.replace(/\.delete/g,".remove"),"rapydscript"==i.lang||"vpython"==i.lang)if(e=n(e,i.lang),"ERROR: "==e.slice(0,7))r(e);else{var o;if("rapydscript"==i.lang)o="def main("+t+"):\n  version = "+c+"\n  window.__GSlang = 'rapydscript'\n  scene = canvas()\n  arange=range\n  _$rapyd$_Temp = 0\n  _$rapyd$_print = GSprint\n"+s+"\n"+e+"main";else{if(o="def main("+t+"):\n  version = "+c+"\n",null===a){o+="  window.__GSlang = 'vpython'\n";for(var p=0;p<f.length;p++)o+="  "+f[p]+"=vp_"+f[p]+"\n";o+="  display=canvas\n  vector=vec\n"+s+"\n"}else if(("visual"==a||"vis"==a)&&l.length>0){var g="  window.__GSlang = 'vpython'\n";g+="  vector=vec\n";for(var p=0;p<f.length;p++){var h=f[p],u=l.indexOf(h);g+=u>=0?"  "+h+"=vp_"+h+"\n":"  "+h+"=undefined\n"}for(var d=l.indexOf("vector")>=0,p=0;p<v.length;p++){var h=v[p];if("vec"!=h||!d){var u=l.indexOf(h);u>=0?"display"==h&&(g+="  display=canvas\n"):g+="  "+h+"=undefined\n"}}o+=g}else if(("visual"==a||"vis"==a)&&0==l.length){var w;w="visual"==a?/visual\.(\w+)/g:/vis\.(\w+)/g;var b=e.match(w);w="visual"==a?/visual\.(\w+)/:/vis\.(\w+)/;for(var m={},p=0;p<b.length;p++){var y=w.exec(b[p])[1];y in m||(m[y]=y)}var g="  window.__GSlang = 'vpython'\n",_="";g+="  "+a+"={";for(var p=0;p<f.length;p++){var h=f[p];h in m?g+=h+":vp_"+h+", ":_+="  "+h+"=undefined\n"}for(var p=0;p<v.length;p++){var h=v[p];if(h in m)g+="display"==h&&h in m?"display:canvas, ":"vector"==h?"vector:vec, ":h+":"+h+", ";else{if("vec"==h&&"vector"in m)continue;_+="  "+h+"=undefined\n"}}g=g.slice(0,-2)+"}\n",o+=g,o+=_}o+="  scene = canvas()\n",o+="  _$rapyd$_Temp=0\n  _$rapyd$_print=GSprint\n  arange=range\n",o+=e+"main"}if(e=r(o),"rapydscript"==i.lang||"vpython"==i.lang){var R=e.indexOf("window.__GSlang"),k="Array.prototype['+']=function(r) {return this.concat(r)};\n";e=e.slice(0,R)+k+e.slice(R-4)}}else{var o="function main("+t+") {\n";o+="var version = "+c+";\n",o+="var scene = canvas();\n",e=o+e+"\n};\nmain"}var E=papercompile(e),o=Streamline.transform(E,{callback:"wait"});return e=o.replace(/\n\n\n\n/g,"")}var a=null,l=[],t=[new RegExp("^rate\\s*\\("),new RegExp("sleep\\s*\\("),new RegExp("^get_library\\s*\\("),new RegExp("\\.waitfor\\s*\\("),new RegExp("\\.pause\\s*\\("),new RegExp("=\\s*read_local_file\\s*\\(")],s="  _$GS_$END=0",c=/"(\d*)"/,o={filename:"demo",toplevel:null,basedir:null,libdir:null},p={beautify:!0,private_scope:!1},f=["box","sphere","cylinder","pyramid","cone","helix","ellipsoid","ring","arrow","graph"],v=["display","vec","vector","rate","sleep","update","compound","color","vertex","triangle","quad","label","distant_light","local_light","attach_trail","attach_arrow","sqrt","pi","abs","sin","cos","tan","asin","acos","atan","atan2","exp","log","pow","factorial","combin","radians","degrees","gcurve","gdots","gvbars","ghbars","gdisplay","get_library","read_local_file"];window.glowscript_compile=i}();
