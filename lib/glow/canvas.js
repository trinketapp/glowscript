   ...
   _shifted[191] = '?'
    ...
    property.declare( canvas.prototype, {
        ...
        width: { value: 480, onchanged: function() { 
            this.__canvas_element.width = this.__canvas_element.style.width = this.__overlay_element.width = this.__overlay_element.style.width = this.__width
            //this.wrapper.width(this.__width + this.__drag_handle.width())
        } },
        height: { value: 300, onchanged: function() { 
        	this.__canvas_element.height = this.__canvas_element.style.height = this.__overlay_element.height = this.__overlay_element.style.height = this.wrapper[0].style.height = this.__height
