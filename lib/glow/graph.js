;(function () {
    ...
    function graph(options) {
    	...
    	if (options.xtitle !== undefined) {
    		if (options.xtitle !== null) this.__xtitle = options.xtitle
    		delete options.xtitle
    	}
    	if (options.ytitle !== undefined) {
    		if (options.ytitle !== null) this.__ytitle = options.ytitle
