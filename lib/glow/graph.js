;(function () {
    ...
    function graph(options) {
        ...
        this.__title = this.__xtitle = this.__ytitle = null
        this.__title_align = 'left'
        this.container = $("<div/>")
        ...
        if (options.title !== undefined) {
        	this.title = print_to_string(options.title) // could be set to None in VPython
            delete options.title
        }
        if (options.title_align !== undefined) {
        	this.title_align = options.title_align
            delete options.title_align
        }
    	if (options.xtitle !== undefined) {
        	this.xtitle = print_to_string(options.xtitle) // could be set to None in VPython
    		delete options.xtitle
    	}
    	if (options.ytitle !== undefined) {
        	this.ytitle = print_to_string(options.ytitle) // could be set to None in VPython
        ...
        */
		...
		var d = 10
		if (this.__title !== null && this.__title !== '') top = d + compute_offset(this.__title)
		if (this.__ytitle !== null && this.__ytitle !== '') {
    ...
    property.declare( graph.prototype, {
        ...
        __update: function() {
            var self = this
            window.requestAnimFrame( function() { self.__update.call(self) }, this.container.get(0) )
            ...
            if (!this.__activated) {
            	...
            	var font = 'Arial'
            	if (this.__title !== null && this.__title !== '') {
	            	x0 = 0
	            	y0 = 15
	            	if (this.__title_align == 'center') x0 = o.left + (this.__width - o.left - o.right)/2
	            	else if (this.__title_align == 'right') x0 = this.__width - o.right
	            	info = parse_html( {ctx: ctx, text: this.__title.toString(), x: x0, y: y0, align: this.__title_align, font: font, fontsize: fontsize, angle: 0} )
	            	display_2D(info)
            	}
            	...
            	if (this.__xtitle !== null && this.__xtitle !== '') {
	            	...
	            	info = parse_html( {ctx: ctx, text: this.__xtitle.toString(), x: x0, y: y0, align: 'center', font: font, fontsize: fontsize, angle: 0} )
	            	display_2D(info)
            	}

            	if (this.__ytitle !== null && this.__ytitle !== '') {
            	x0 = 15
	            	y0 = o.top + (this.__height - o.bottom -15)/2
	            	info = parse_html( {ctx: ctx, text: this.__ytitle.toString(), x: x0, y: y0, align: 'center', font: font, fontsize: fontsize, angle: -Math.PI/2} )
	            	display_2D(info)
            	}
            }
            this.__activated = true
    	...
    	title: {
	        ...
	        set: function (value) {
	        	if (this.__activated) throw new Error("Cannot change title after the graph is activated.")
            	this.__title = value
	        }
    	},
    	title_align: {
	        get: function () { return this.__title_align },
	        set: function (value) {
	        	if (this.__activated) throw new Error("Cannot change title_align after the graph is activated.")
            	this.__title_align = value
	        }
    	},
    	xtitle: {
	        get: function () { return this.__xtitle},
	        set: function (value) {
	        	if (this.__activated) throw new Error("Cannot change xtitle after the graph is activated.")
                this.__xtitle = value
	        }
    	},
    	ytitle: {
	        ...
	        set: function (value) {
	        	if (this.__activated) throw new Error("Cannot change ytitle after the graph is activated.")
                this.__ytitle = value
	        }
    	},
        width: {
    ...
    // containers for VPython programs to use GlowScript graph capabilities
