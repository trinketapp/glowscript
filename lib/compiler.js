 ...
 */
    ...
    function preprocess(program, lang) { // manipulate the program source
    	...
    	// After CoffeeScript compilation these take the form of /*N */.
...
*/
    ...
    function compile(program, options) {
    	...
    	// invoke a function "srequire" inside the streamline machinery. Adding transform-all.js
    	// to glow.1.1.min.js run-time libraries did not make srequire available to exported programs, alas.
    	// Hence this kludge. You can see that this code is similar to that at line 5358 in transform-all.js.
        var preamble = "var __g=typeof global!=='undefined'?global:window; __g=(__g.__streamline||(__g.__streamline={}));__g.setEF=__g.setEF||function(e,f){e.__frame = e.__frame||f};var __srcName='undefined_.js'; "
		...
		var end = prog.indexOf('return main;')
		if (end > 0) prog = prog.slice(0,end)+'main__1' // fix up CoffeeScript prog
